...
def seed_all():
    ...
    # ========================================
    users = [
        create_user('admin@footapp.fr', generate_password_hash('admin123'), 'admin', club1_id, 
...
if __name__ == '__main__':
    ...
    import sys
    sys.path.insert(0, 'c:/Users/Soufiane/repos/FootApp/footapp_project/footapp_v2')
